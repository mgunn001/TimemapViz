...
function SimhashCacheFile(forUri, isDebugMode){
		...
		this.path = __dirname+'/cache/simhashes_' + forUri.replace(/[^a-z0-9]/gi, '').toLowerCase();
		this.timemapSumJsonPath= __dirname+'/cache/timemapsumjson_'+forUri.replace(/[^a-z0-9]/gi, '').toLowerCase();
